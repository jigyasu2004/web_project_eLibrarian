...
const AddBook = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3001/book/add', { name, author, imageUrl, ISBNCode, availableQuantity })
            .then(res => {
                if (res.data.added) {
                    navigate('/books');
                } else {
        ...
        <div className="student-form-container">
            <form className="student-form" onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" id="ISBN" name="ISBN" onChange={(e) => setISBNCode(e.target.value)} />
                </div>
                <div className="form-group">
                    <label htmlFor="quantity">Available Quantity:</label>
                    <input type="number" id="quantity" name="quantity" onChange={(e) => setAvailableQuantity(e.target.value)} />
                </div>
